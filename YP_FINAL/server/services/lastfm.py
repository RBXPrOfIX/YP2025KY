...
def fetch_tags_lastfm(title: str, artist: str) -> list[str]:
    ...
    "conscious rap", "meme rap", "battle rap", "crunk", "hyphy", "bounce", "miami bass",

    # Поп-сцена и смежное
    "bubblegum pop", "teen pop", "pop punk", "synthpop", "baroque pop", "indie pop",
    "electro pop", "dream pop", "power pop", "art pop", "glam rock", "britpop",

    # Рок и альтернативная сцена
    "arena rock", "garage rock", "space rock", "stoner rock", "folk rock", "blues rock", "glam rock",
    "punk rock", "emo rock", "math rock", "post-hardcore", "screamo", "noise rock", "psych rock",
    "sludge rock", "southern rock", "rap rock", "crossover thrash",
    ...
    # Прочие и гибридные
    "spoken word", "a cappella", "field recordings", "noise", "avant-garde", "contemporary classical",
    "meditative", "healing", "new age", "relaxation", "sound healing", "nature sounds", "asmr",
    "tiktok music", "meme music", "experimental hip-hop", "satanic metal", "occult rock"
}
    ...
    logger.debug(f"[LastFM] fallback: HTML scrape for {artist}/{title}")
    try:
